...
?>
   ...
   <!-- Payment -->
    ...
    <section class="my-5 py-5">
        ...
        <!-- Set up a container element for the button -->
        <!-- <div class="mx-auto container text-center" id="paypal-button-container"></div> -->
  ...
  paypal.Buttons({
    ...
    createOrder: function(data, actions) {
      return actions.order.create({
        purchase_units: [{
          amount: {
            value: '<?php echo $amount; ?>' // Can reference variables or functions. Example: `value: variableName`
          }
        }]
      });
    },
